...
Money is genuinely the least useful thing on this list.
...
> It is the signal other people use to judge whether a SharePoint web part from
> a stranger is worth installing.
> **[Star it →](https://github.com/CodyRWhite/Markstrata)**

> [!TIP] Tell someone at work
> Most of the people who would benefit from this do not know markdown web parts
> for SharePoint exist, let alone that one of them looks like their editor.
...
Nothing dramatic, and it is worth being honest about it: there are no server
costs, because the site is GitHub Pages and the web part runs entirely inside
your own tenant. There is no company. It buys the odd domain renewal, and it
