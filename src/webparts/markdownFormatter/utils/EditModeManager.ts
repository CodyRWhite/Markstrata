...
export class EditModeManager {
  ...
  public render(host: HTMLElement, markdown: string, options: IEditOptions): void {
    ...
    editorPane.className = 'mdf-editor-pane';
    editorPane.appendChild(this.paneLabel('Markdown'));

    this.textarea = document.createElement('textarea');
    this.textarea.className = 'mdf-editor-input';
    ...
    previewPane.className = 'mdf-preview-pane';
    previewPane.appendChild(this.paneLabel('Preview'));

    this.preview = document.createElement('div');
    this.preview.className = 'mdf-content';
  ...
  private buildToolbar(editor: HTMLElement, options: IEditOptions): HTMLElement {
    ...
    layouts.forEach((entry) => {
      ...
      button.addEventListener('click', () => {
        ...
        Array.prototype.slice
          .call(toolbar.querySelectorAll('.mdf-btn[aria-pressed]'))
    ...
    if (options.canSave) {
      ...
      save.type = 'button';
      save.className = 'mdf-btn mdf-btn-primary';
  ...
  private paneLabel(text: string): HTMLElement {
    ...
    label.className = 'mdf-pane-label';
