...
export class ThemeManager {
  ...
  public static apply(element: HTMLElement, settings: IThemeSettings, resolved: ResolvedMode): void {
    element.classList.add('mdf-root');
    element.setAttribute('data-mdf-theme', settings.themeFamily);
    element.setAttribute('data-mdf-mode', resolved);
    element.setAttribute('data-mdf-width', settings.contentWidth);
    element.setAttribute('data-mdf-density', settings.density);
    element.setAttribute('data-mdf-size', settings.textSize);
    element.setAttribute('data-mdf-code-size', settings.codeSize);
